...
const StudentDetails = (props)=>{
    ...
    return (
        ...
        <div className="alert alert-secondary">
            ...
            <p className="h4 text-muted">age: {studentInfo.age}</p>
            <p className="h4 text-muted">phone: {studentInfo.phone}</p>
            ...
            <div className={`alert ${fade} alert-danger w-50 m-auto`}>
                ...
                <button className="btn btn-danger mx-3"onClick={deleteStudent}>yes</button>
                <button className="btn btn-primary mx-3 "onClick={fadeConfirmation}>cancel</button>
                </div>
            </div>
        </div>
